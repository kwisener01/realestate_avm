"""
Training script for text model
"""
...
def main(args):
    print("Loading data...")
    # Load processed data with descriptions
    ...
    model_path = os.path.join(args.output_dir, 'text_model.pth')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, required=True,
                       help='Path to processed data CSV with descriptions')
